                ...
                <div className="col-md-4 mt-3 col-12 card shadow">
                    <div className="card text-start">
                        ...
                        <div className="card-body">
                            ...
                            <span className="card-text" style={{ color: "black" }}><icon className='fa fa-clock'></icon> {` Jam Operasional: ${props.jamOperasional}`}</span><br></br>
                            ...
                            <span className="card-text text-muted" style={{ color: "black" }}><strong>Harga mulai dari </strong><br></br><span style={{ color: "green" }}>{props.lapanganVenue.length === 0 ? ('Tidak ada data lapangan') : (rupiah(props.lapanganVenue[0].hargaPagi))}</span></span>
                        </div>
                    </div>
                </div>
            </Link>
